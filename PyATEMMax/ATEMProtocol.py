...
class ATEMProtocol:
    ...
    commands = {
        ...
        "LOCK": 'Lock State Change',
        "LKST": 'Lock Status',
        "FTCD": 'File Transfer Continue Download',
        "FTDC": 'File Transfer Download Complete',
        "FTDa": 'File Transfer Data',
        "FTFD": 'File Transfer File Description',
        "FTSU": 'File Transfer Start Upload',
        "FTSD": 'File Transfer Start Download',
